[![Java CI](https://github.com/GnusovDmitrii/Patterns_1/actions/workflows/gradle.yml/badge.svg)](https://github.com/GnusovDmitrii/Patterns_1/actions/workflows/gradle.yml)
...
**Важно:** в этот раз вы не должны хардкодить данные прямо в тест. Используйте
Faker, [Lombok](https://projectlombok.org/setup/gradle), data-классы для группировки нужных полей и утилитный
класс-генератор данных —
см. [пример](https://github.com/netology-code/aqa-code/blob/master/patterns/patterns-task1/src/test/java/ru/netology/delivery/data/DataGenerator.java).
